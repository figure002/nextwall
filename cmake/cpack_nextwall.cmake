...
set (CPACK_SOURCE_IGNORE_FILES ".git;.gitignore;build;icons/src")

set (CPACK_DEBIAN_PACKAGE_NAME "nextwall")
set (CPACK_PACKAGE_DESCRIPTION_SUMMARY "Wallpaper changer for GNOME\n NextWall is a small script that changes the wallpaper of the GNOME desktop to a random image. NextWall can operate as a command-line tool, but can also place itself in the GNOME panel. The fit time of day feature automatically sets wallpapers that fit the time of day (dark backgrounds at night, bright backgrounds at day, intermediate at twilight).")
...
set (CPACK_DEBIAN_PACKAGE_DEPENDS "python (>=2.6), python-gtk2, imagemagick, libappindicator-dev, python-appindicator, python-dateutil")
set (CPACK_DEBIAN_PACKAGE_SECTION "GNOME")
set (CPACK_DEBIAN_PACKAGE_VERSION ${CPACK_PACKAGE_VERSION})
set (CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_BINARY_DIR}/cmake/debian/postinst")
